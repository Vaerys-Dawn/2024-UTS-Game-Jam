...
{
	[Header("Stats")]
	public MeleeComboInfo[] comboInfo;
    public float attackCooldown = 0.2f;
    public float comboTime = 0.4f;
	public int maxCombo = 1;
    public float damageTakenIFrames;


    [HideInInspector] public float gravityStrength; //Downwards force (gravity) needed for the desired jumpHeight and jumpTimeToApex.
	[HideInInspector] public float gravityScale; //Strength of the player's gravity as a multiplier of gravity (set in ProjectSettings/Physics2D).

    [Header("Gravity")]                                       //Also the value the player's rigidbody2D.gravityScale is set to.
	...
	public float wallClimbAccel;

    [Header("Wall Slide")]
    public float wallSlideSpeed;
    public float wallSlideAccel;
    public float minimumWallSlideSpeed;
    ...
    public float slideSleepTime; //Duration for which the game freezes when we press dash but before we read directional input and apply a force
    [Space(5)]
    public float slideAttackTime;
    [Space(5)]
    public float slideEndTime; //Time after you finish the inital drag phase, smoothing the transition back to idle (or any standard state)
    public Vector2 slideEndSpeed; //Slows down player, makes dash feel more responsive (used in Celeste)
    [Range(0f, 1f)] public float slideEndRunLerp; //Slows the affect of player movement while dashing
    [Space(5)]
    public float slideRefillTime;
    [Space(5)]
    [Range(0.01f, 0.5f)] public float slideInputBufferTime;

    [Space(20)]

    [Header("Grapple")]
    public float maxGrappleSpeed;
    [Range(0.01f, 1f)] public float grappleLerpAmount;
    public float grappleAccelRate;
	[Space(5)]
    public float maxGrappleObjectSpeed;
    [Range(0.01f, 1f)] public float grappleObjectLerpAmount;
    public float grappleObjectAccelRate;
    [Space(5)]
